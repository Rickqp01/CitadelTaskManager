<?php 
/**
* Mailborder SimpleMail Class
*
* @author Jerry Benton <jerry.benton@mailborder.com>
* @version 5.x
*/

/* simple mail class for sending email */
class SimpleMail{
    /**
     * @var int $_wrap
     */
    ...
    public function filterName($name)
    {
        ...
        $filtered = strip_tags($name); this doesn't work
        */
    ...
    public function getHeadersForSend()
    {
        ...
        if(!in_array('MIME-Version: 1.0', $this->_headers)){
            $this->_headers[] = "MIME-Version: 1.0";
        }
